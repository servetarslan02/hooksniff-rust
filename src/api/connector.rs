...
impl<'a> Connector<'a> {
    ...
    pub async fn list(
        ...
        crate::request::Request::new(http1::Method::GET, "/v1/connector")
    ...
    pub async fn create(
        ...
        crate::request::Request::new(http1::Method::POST, "/v1/connector")
    ...
    pub async fn get(&self, connector_id: String) -> Result<ConnectorOut> {
        crate::request::Request::new(http1::Method::GET, "/v1/connector/{connector_id}")
    ...
    pub async fn update(
        ...
        crate::request::Request::new(http1::Method::PUT, "/v1/connector/{connector_id}")
            .with_path_param("connector_id", connector_id)
    ...
    pub async fn delete(&self, connector_id: String) -> Result<()> {
        crate::request::Request::new(http1::Method::DELETE, "/v1/connector/{connector_id}")
            .with_path_param("connector_id", connector_id)
            .returns_nothing()
            .execute(self.cfg)
            .await
    ...
    pub async fn patch(
        ...
        crate::request::Request::new(http1::Method::PATCH, "/v1/connector/{connector_id}")
            .with_path_param("connector_id", connector_id)

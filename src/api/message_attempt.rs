...
impl<'a> MessageAttempt<'a> {
    ...
    pub async fn list_by_endpoint(
        ...
        crate::request::Request::new(
            http1::Method::GET,
            "/v1/webhooks/attempts/endpoint/{endpoint_id}",
        )
    ...
    pub async fn list_attempted_messages(
        ...
        crate::request::Request::new(
            http1::Method::GET,
            "/v1/webhooks/endpoint/{endpoint_id}",
        )
        .with_path_param("endpoint_id", endpoint_id)
        .with_optional_query_param("limit", limit)
        .with_optional_query_param("iterator", iterator)
    ...
    pub async fn list_attempts_for_endpoint(
        ...
        crate::request::Request::new(
            http1::Method::GET,
            "/v1/webhooks/{msg_id}/endpoint/{endpoint_id}/attempt",
        )
        .with_optional_query_param("limit", limit)
        .with_optional_query_param("iterator", iterator)
        .with_optional_query_param("channel", channel)
    ...
    pub async fn resend(
        ...
        crate::request::Request::new(
            http1::Method::POST,
            "/v1/webhooks/{msg_id}/endpoint/{endpoint_id}/resend",
        )
        .with_path_param("msg_id", msg_id)
        .with_path_param("endpoint_id", endpoint_id)

...
impl<'a> Message<'a> {
    ...
    pub async fn list(
        ...
        crate::request::Request::new(http1::Method::GET, "/v1/webhooks")
    ...
    /// message). HookSniff supports payload sizes of up to 1MiB, though it's
    ...
    pub async fn create(
        ...
        crate::request::Request::new(http1::Method::POST, "/v1/webhooks")
            .with_optional_query_param("with_content", with_content)
    ...
    pub async fn get(
        ...
        crate::request::Request::new(http1::Method::GET, "/v1/webhooks/{msg_id}")
    ...
    pub async fn expunge_content(&self, msg_id: String) -> Result<()> {
        crate::request::Request::new(
            http1::Method::DELETE,
            "/v1/webhooks/{msg_id}/content",
        )
        .with_path_param("msg_id", msg_id)
        .returns_nothing()
        .execute(self.cfg)
    ...
    pub async fn events(
        ...
        crate::request::Request::new(http1::Method::GET, "/v1/events")
            .with_optional_query_param("limit", limit)
            .with_optional_query_param("iterator", iterator)
            .with_optional_query_param("event_types", event_types)
    ...
    pub async fn events_subscription(
        ...
        crate::request::Request::new(
            http1::Method::GET,
            "/v1/events/subscription/{subscription_id}",
        )

...
impl<'a> StreamingStream<'a> {
    ...
    pub async fn publish(&self, body: PublishEventIn) -> Result<PublishEventResponse> {
    ...
    pub async fn list_subscriptions(&self, stream_id: String) -> Result<Vec<StreamSubscriptionOut>> {

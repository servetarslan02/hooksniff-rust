...
impl<'a> StreamingSink<'a> {
    ...
    pub async fn list(
        ...
        crate::request::Request::new(http1::Method::GET, "/v1/stream/{stream_id}/sink")
    ...
    pub async fn create(
        ...
        crate::request::Request::new(http1::Method::POST, "/v1/stream/{stream_id}/sink")
            .with_path_param("stream_id", stream_id)
    ...
    pub async fn get(&self, stream_id: String, sink_id: String) -> Result<StreamSinkOut> {
        crate::request::Request::new(
            http1::Method::GET,
            "/v1/stream/{stream_id}/sink/{sink_id}",
        )
        .with_path_param("stream_id", stream_id)
    ...
    pub async fn get_secret(&self, stream_id: String, sink_id: String) -> Result<SinkSecretOut> {
        crate::request::Request::new(
            http1::Method::GET,
            "/v1/stream/{stream_id}/sink/{sink_id}/secret",
        )
        .with_path_param("stream_id", stream_id)
        .with_path_param("sink_id", sink_id)
        .execute(self.cfg)
    ...
    pub async fn rotate_secret(
        ...
        crate::request::Request::new(
            http1::Method::POST,
            "/v1/stream/{stream_id}/sink/{sink_id}/secret/rotate",
        )
        .with_path_param("stream_id", stream_id)
        .with_path_param("sink_id", sink_id)
        .with_optional_header_param("idempotency-key", idempotency_key)
    ...
    pub async fn transformation_partial_update(
        ...
        crate::request::Request::new(
            http1::Method::PATCH,
            "/v1/stream/{stream_id}/sink/{sink_id}/transformation",
        )
        .with_path_param("stream_id", stream_id)
        .with_path_param("sink_id", sink_id)

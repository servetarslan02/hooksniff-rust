...
impl<'a> Endpoint<'a> {
    ...
    pub async fn list(
        ...
        crate::request::Request::new(http1::Method::GET, "/v1/endpoints")
    ...
    pub async fn create(
        ...
        crate::request::Request::new(http1::Method::POST, "/v1/endpoints")
    ...
    /// Get an endpoint.
    pub async fn get(&self, endpoint_id: String) -> Result<EndpointOut> {
    ...
    pub async fn bulk_replay(
        ...
        crate::request::Request::new(
            http1::Method::POST,
            "/v1/endpoints/{endpoint_id}/bulk-replay",
        )
        .with_path_param("endpoint_id", endpoint_id)
        .with_optional_header_param("idempotency-key", idempotency_key)
    ...
    pub async fn recover(
        ...
        crate::request::Request::new(
            http1::Method::POST,
            "/v1/endpoints/{endpoint_id}/recover",
        )
        .with_path_param("endpoint_id", endpoint_id)
        .with_optional_header_param("idempotency-key", idempotency_key)
    ...
    pub async fn replay_missing(
        ...
        crate::request::Request::new(
            http1::Method::POST,
            "/v1/endpoints/{endpoint_id}/replay-missing",
        )
        .with_path_param("endpoint_id", endpoint_id)
        .with_optional_header_param("idempotency-key", idempotency_key)
    ...
    pub async fn get_secret(
        ...
        crate::request::Request::new(
            http1::Method::GET,
            "/v1/endpoints/{endpoint_id}/secret",
        )
        .with_path_param("endpoint_id", endpoint_id)
        .execute(self.cfg)
        .await
    ...
    pub async fn rotate_secret(
        ...
        crate::request::Request::new(
            http1::Method::POST,
            "/v1/endpoints/{endpoint_id}/secret/rotate",
        )
        .with_path_param("endpoint_id", endpoint_id)
        .with_optional_header_param("idempotency-key", idempotency_key)
    ...
    pub async fn send_example(
        ...
        crate::request::Request::new(
            http1::Method::POST,
            "/v1/endpoints/{endpoint_id}/send-example",
        )
        .with_path_param("endpoint_id", endpoint_id)
        .with_optional_header_param("idempotency-key", idempotency_key)
    ...
    pub async fn get_stats(
        ...
        crate::request::Request::new(
            http1::Method::GET,
            "/v1/endpoints/{endpoint_id}/stats",
        )
        .with_path_param("endpoint_id", endpoint_id)

...
pub struct ApplicationListOptions {
    ...
    /// Exclude applications that only have HookSniff Play endpoints. Default is
    /// false.
    pub exclude_apps_with_hooksniff_play_endpoints: Option<bool>,
...
impl<'a> Application<'a> {
    ...
    pub async fn list(
        ...
        let ApplicationListOptions {
            ...
            exclude_apps_with_hooksniff_play_endpoints,
            limit,
            iterator,
            order,
        } = options.unwrap_or_default();

        crate::request::Request::new(http1::Method::GET, "/v1/applications")
    ...
    pub async fn create(
        ...
        crate::request::Request::new(http1::Method::POST, "/v1/applications")
    ...
    pub async fn get(&self, app_id: String) -> Result<ApplicationOut> {
        crate::request::Request::new(http1::Method::GET, "/v1/applications/{app_id}")
    ...
    pub async fn update(
        ...
        crate::request::Request::new(http1::Method::PUT, "/v1/applications/{app_id}")
            .with_path_param("app_id", app_id)
            .with_body_param(application_in)
            .execute(self.cfg)
            .await
    ...
    pub async fn delete(&self, app_id: String) -> Result<()> {
        crate::request::Request::new(http1::Method::DELETE, "/v1/applications/{app_id}")
            .with_path_param("app_id", app_id)
            .returns_nothing()
            .execute(self.cfg)
            .await
    ...
    pub async fn patch(
        ...
        crate::request::Request::new(http1::Method::PATCH, "/v1/applications/{app_id}")
            .with_path_param("app_id", app_id)

...
impl<'a> RateLimit<'a> {
    ...
    pub async fn get(&self, endpoint_id: String) -> Result<RateLimitOut> {
        crate::request::Request::new(http1::Method::GET, "/v1/endpoints/{endpoint_id}/rate-limit")
    ...
    pub async fn set(&self, endpoint_id: String, rate_limit_in: RateLimitIn) -> Result<RateLimitOut> {
        crate::request::Request::new(http1::Method::PUT, "/v1/endpoints/{endpoint_id}/rate-limit")
            .with_path_param("endpoint_id", endpoint_id)
    ...
    pub async fn delete(&self, endpoint_id: String) -> Result<()> {
        crate::request::Request::new(http1::Method::DELETE, "/v1/endpoints/{endpoint_id}/rate-limit")
            .with_path_param("endpoint_id", endpoint_id)
            .returns_nothing()
            .execute(self.cfg).await
    }

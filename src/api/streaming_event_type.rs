...
impl<'a> StreamingEventType<'a> {
    ...
    pub async fn list(
        ...
        crate::request::Request::new(http1::Method::GET, "/v1/stream/event-type")
    ...
    pub async fn create(
        ...
        crate::request::Request::new(http1::Method::POST, "/v1/stream/event-type")
    ...
    pub async fn get(&self, name: String) -> Result<StreamEventTypeOut> {
        crate::request::Request::new(http1::Method::GET, "/v1/stream/event-type/{name}")
    ...
    pub async fn update(
        ...
        crate::request::Request::new(http1::Method::PUT, "/v1/stream/event-type/{name}")
            .with_path_param("name", name)
            .with_body_param(stream_event_type_in)
            .execute(self.cfg)
            .await
    ...
    pub async fn delete(
        ...
        crate::request::Request::new(http1::Method::DELETE, "/v1/stream/event-type/{name}")
            .with_path_param("name", name)
    ...
    pub async fn patch(
        ...
        crate::request::Request::new(http1::Method::PATCH, "/v1/stream/event-type/{name}")
            .with_path_param("name", name)

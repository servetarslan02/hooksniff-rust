...
impl MessageIn {
    ...
    /// required to be JSON, and HookSniff will minify the payload before sending
    ...
    /// the webhook sent by HookSniff, unless overwritten with
    ...
    /// Set the `content-type` header to use for the webhook sent by HookSniff.

...
use hooksniff::api::{
    ...
    ListResponseApplicationOut, SegmentConfig, SegmentConfigOut, HookSniffConfig, HookSniffConfigOut,
};
...
fn test_ingest_source_in() {
    ...
    assert_eq!(
        json!(IngestSourceIn {
            name: "foo".to_owned(),
            uid: None,
            config: IngestSourceInConfig::HookSniff(HookSniffConfig {
                secret: "xxx".to_owned()
            }),
            metadata: Some(HashMap::new())
        }),
...
fn test_ingest_source_out() {
    ...
    assert_deserializes_to(
        ...
        IngestSourceOut {
            ...
            uid: None,
            updated_at: "2006-01-02T15:04:05Z".to_owned(),
            config: IngestSourceOutConfig::HookSniff(HookSniffConfigOut {}),
            metadata: HashMap::new(),
        },
    );
